...
alias tfap='terraform apply -auto-approve .terraform.plan'
...
alias tfip='tfi && terraform plan -out .terraform.plan'
alias tfipa='tfi && terraform plan -out .terraform.plan && terraform apply -auto-approve .terraform.plan'
