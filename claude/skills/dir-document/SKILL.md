---
name: dir-document
description: Use when asked to analyze, document, or create a CLAUDE.md for a specific directory or module — including "document this module", "analyze this directory", or before major changes to a subsystem.
---

# dir-document

Analyze a directory's architecture and produce a CLAUDE.md that gives future Claude sessions accurate, actionable context.
...
### 2. Analyze — answer these questions
...
Omit sections that have nothing non-obvious to say. A short honest file beats a padded comprehensive one.
