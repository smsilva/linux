...
Ignore if the export command fails with the message below:
...
The complete draw.io XML reference is available locally at: `xml-reference.md`

Read that file for the full reference on common styles, edge routing, containers, layers, tags, metadata, dark mode colors, and XML well-formedness rules.
