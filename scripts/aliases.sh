...
alias aglp='agl | grep -E "Name|^wasp|^be.*platform-c|^be.*platform-a"'
...
alias tfap='terraform apply -auto-approve output/terraform.plan'
...
alias tfip='tfi && terraform plan -out output/terraform.plan'
alias tfipa='tfi && terraform plan -out output/terraform.plan && terraform apply -auto-approve output/terraform.plan'
alias tfo='terraform output'
alias tfoc='terraform output | column -t'
alias tfoj='terraform output -json | jq'
alias tfp='terraform plan -out output/terraform.plan'
alias tfs='tfswitch'
